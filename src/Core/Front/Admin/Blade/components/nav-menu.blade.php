...
<li class="mb-0.5" x-data="{ expanded: {{ $isExpanded ? 'true' : 'false' }} }">
 <a class="block text-fg-0 truncate transition hover:text-fg-0 dark:hover:text-fg-0 pl-4 pr-3 py-2 rounded-lg @if($active) bg-linear-to-r from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04] @endif"
 href="#"
 ...
 <svg class="w-3 h-3 shrink-0 fill-current text-fg-3 dark:text-fg-2 transition-transform duration-200" :class="{ 'rotate-180': expanded }" viewBox="0 0 12 12">
