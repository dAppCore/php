...
<li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r @if($active) from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04] @endif" x-data>
 <a class="block text-fg-0 truncate transition @if(!$active) hover:text-fg-0 dark:hover:text-fg-0 @endif"
 href="{{ $href }}"
 ...
 @if($badge)
 <span class="text-xs bg-amber-500 text-fg-0 px-1.5 py-0.5 rounded-full duration-200"
